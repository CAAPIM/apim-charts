...
| `disklessConfig.setSecretByInitContainer`          | set up and mount node.properties secret by InitContainer and copy to final location by Bootstrap Script                                                      | `false`                                                                                                                                       |
...
[Bootstrap Script] will copy it to the right location.
