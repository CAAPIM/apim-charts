...
| `otk.database.readOnlyConnection.enabled`     | OTK database connection name | `OAuth_ReadOnly`
...
| `otk.database.readOnlyConnection.properties`         | OTK ReadOnly database additional connection properties  | `otk.database.sql.properties`
