...
| `otk.forceInstallOrUpgrade`                            | Force install or upgrade by uninstalling existing otk solution kit and install.                                                                                                                                                                                                                                                                | false | 
...
| `otk.subSolutionKitNames`                              | List of comma separated sub solution Kits to install or upgrade.                                                                                                                                                                                                                                                                               |
...
| `otk.job.image.labels`                                 | Job labels                                                                                                                                                                                                                                                                                                                                     | `{}` | 
...
| `otk.job.bundle.enabled`                               | Creates a configmap with bundles from the ./bundles folder                                                                                                                                                                                                                                                                                     | `false`  |
| `otk.job.bundle.path`                                  | Specify the path to the bundle files. The bundles folder in this repo has some example bundle files                                                                                                                                                                                                                                            | `"bundles/*.bundle"`  |
| `otk.job.existingBundle.enabled`                       | Enable mounting existing configMaps that contain Layer7 Gateway Bundles - see values.yaml for more info                                                                                                                                                                                                                                        | `false`  |
| `otk.job.existingBundle.configMaps`                    | Array of configMaps that will be mounted to the OTK install job for customing the otk policies/services                                                                                                                                                                                                                                        | `see values.yaml`  |
