...
helm install -f $EDGE_VALUES_YAML_FILE_REPLACED $EDGE_RELEASE_NAME ../../../gateway-sts --set-file "ssg.license.value=./LICENSE.xml" --set "ssg.tls.customDefaultSslKey.key=$EDGE_KEY" --set "ssg.license.accept=true"
